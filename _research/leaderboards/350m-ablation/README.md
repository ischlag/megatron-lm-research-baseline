...
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- |
| 1 | scion-qkn-moe-32e-tk3-sh1-lr3e-4 | scion-qkn-lr3e-4 | replace dense FFN with 32 routed experts top-3 + 1 shared expert (all width 640); active 355M, total ~1.73B (DeepSeek-V3-style fine-grained MoE) | Scion + QK norm + MoE | 3e-4 | **2.078** | **1.913** | [`20-scion-qkn-moe-32e-tk3-sh1-lr3e-4.sbatch`](runs/20-scion-qkn-moe-32e-tk3-sh1-lr3e-4.sbatch) | [x01paa25](https://wandb.ai/puigde-epfl-epfl/megatron-lm-research-baseline/runs/x01paa25) | [`bc484b2b1`](https://github.com/ischlag/megatron-lm-research-baseline/tree/bc484b2b1) |
| 2 | aurora-qkn-moe-32e-tk3-sh1 | aurora-qkn | replace dense FFN with 32 routed experts top-3 + 1 shared expert (all width 640); active 355M, total ~1.73B (DeepSeek-V3-style fine-grained MoE) | Aurora + QK norm + MoE | 1e-2 | 2.098 | 1.934 | [`16-aurora-qkn-moe-32e-tk3-sh1.sbatch`](runs/16-aurora-qkn-moe-32e-tk3-sh1.sbatch) | [5ttumu3u](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/5ttumu3u) | [`c664f35d2`](https://github.com/ischlag/megatron-lm-research-baseline/tree/c664f35d2) |
| 3 | scion-qkn-lr3e-4 | scion-lr3e-4 | add `--qk-layernorm` (RMSNorm on Q, K) | Scion + QK norm | 3e-4 | 2.167 | 2.005 | [`19-scion-qkn-lr3e-4.sbatch`](runs/19-scion-qkn-lr3e-4.sbatch) | [nospddzg](https://wandb.ai/puigde-epfl-epfl/megatron-lm-research-baseline/runs/nospddzg) | [`bc484b2b1`](https://github.com/ischlag/megatron-lm-research-baseline/tree/bc484b2b1) |
| 4 | aurora-qkn-xsa | aurora-qkn | add `--exclusive-self-attention` (XSA, GQA-aware + torch.compile) | Aurora + QK norm + XSA | 1e-2 | 2.167 | 2.009 | [`12-aurora-qkn-xsa.sbatch`](runs/12-aurora-qkn-xsa.sbatch) | [mdmnb7mc](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/mdmnb7mc) | [`435b3cf2d`](https://github.com/ischlag/megatron-lm-research-baseline/tree/435b3cf2d) |
| 5 | aurora-xsa | aurora-lr1e-2 | add `--exclusive-self-attention` (XSA) | Aurora + XSA | 1e-2 | 2.183 | 2.023 | [`13-aurora-xsa.sbatch`](runs/13-aurora-xsa.sbatch) | [w6vimrkm](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/w6vimrkm) | [`e994bb632`](https://github.com/ischlag/megatron-lm-research-baseline/tree/e994bb632) |
| 6 | aurora-qkn | aurora-lr1e-2 | add `--qk-layernorm` (RMSNorm on Q, K) | Aurora + QK norm | 1e-2 | 2.185 | 2.025 | [`09-aurora-qkn.sbatch`](runs/09-aurora-qkn.sbatch) | [s5e3c4bm](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/s5e3c4bm) | [`f3816b24e`](https://github.com/ischlag/megatron-lm-research-baseline/tree/f3816b24e) |
| 7 | aurora-qkn-fp8 | aurora-qkn | add `--fp8-format e4m3 --fp8-recipe blockwise` (DeepSeek-V3) | Aurora + QK norm (FP8) | 1e-2 | 2.188 | 2.027 | [`11-aurora-qkn-fp8.sbatch`](runs/11-aurora-qkn-fp8.sbatch) | [guwuunre](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/guwuunre) | [`6db3a8f8b`](https://github.com/ischlag/megatron-lm-research-baseline/tree/6db3a8f8b) |
| 8 | scion-lr3e-4 |  | root: Scion (Pethick et al., 2025, norm-LMO Frank-Wolfe; Spectral hidden ρ50, Sign head/embed ρ3000, BiasRMS norm-gains ρ50; quintic@5, μ=1, mom 0.9), matrix LR 3e-4 | Scion | 3e-4 | 2.196 | 2.036 | [`18-scion-lr3e-4.sbatch`](runs/18-scion-lr3e-4.sbatch) | [ewx2zmxm](https://wandb.ai/puigde-epfl-epfl/megatron-lm-research-baseline/runs/ewx2zmxm) | [`bc484b2b1`](https://github.com/ischlag/megatron-lm-research-baseline/tree/bc484b2b1) |
| 9 | aurora-lr1e-2 | normuon-lr3.6e-4 | Aurora polar (Tilde): row-uniform Stiefel; matrix LR rescaled to 1e-2 | Aurora | 1e-2 | 2.200 | 2.038 | [`08-aurora-lr1e-2.sbatch`](runs/08-aurora-lr1e-2.sbatch) | [czxm4be0](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/czxm4be0) | [`c51a272dd`](https://github.com/ischlag/megatron-lm-research-baseline/tree/c51a272dd) |
| 10 | aurora-qkn-learned-sink | aurora-qkn | add `--softmax-type learnable` (gpt-oss per-head learned sink bias) | Aurora + QK norm + learned sink | 1e-2 | 2.201 | 2.040 | [`15-aurora-qkn-learned-sink.sbatch`](runs/15-aurora-qkn-learned-sink.sbatch) | [9n4abgdu](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/9n4abgdu) | [`435b3cf2d`](https://github.com/ischlag/megatron-lm-research-baseline/tree/435b3cf2d) |
| 11 | aurora-qkn-softmax1 | aurora-qkn | add `--softmax-type off-by-one` (Evan Miller softmax1 sink) | Aurora + QK norm + softmax1 | 1e-2 | 2.203 | 2.027 | [`14-aurora-qkn-softmax1.sbatch`](runs/14-aurora-qkn-softmax1.sbatch) | [tz4vr1ng](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/tz4vr1ng) | [`bd77a2f32`](https://github.com/ischlag/megatron-lm-research-baseline/tree/bd77a2f32) |
| 12 | deltanet-perchgate-carry-v2-cap200 | normuon-lr3.6e-4 | swap 18/24 softmax-attention layers for Schlag DeltaNet (3:1 hybrid) with per-channel output gate, full per-batch carry-v2 of recurrent state, hard Frobenius cap 200 on per-element carried state | NorMuon (DN+carry-v2+cap200) | 3.6e-4 | 2.207 | 2.045 | [`17-deltanet-perchgate-carry-v2-cap200.sbatch`](runs/17-deltanet-perchgate-carry-v2-cap200.sbatch) | (dev) | [`91920d23d`](https://github.com/ischlag/megatron-lm-research-baseline/tree/91920d23d) |
| 13 | normuon-lr3.6e-4 | muon-kj-lr2e-2 | adaptive_muon (NorMuon per-row 2nd moment); LR rescaled to 3.6e-4 | NorMuon | 3.6e-4 | 2.224 | 2.061 | [`01-normuon-lr3.6e-4.sbatch`](runs/01-normuon-lr3.6e-4.sbatch) | [0l47egjv](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/0l47egjv) | [`baseline-2026-05-08-0b2385c`](https://github.com/ischlag/megatron-lm-research-baseline/tree/baseline-2026-05-08-0b2385c) |
| 14 | muon-kj-lr2e-2 |  | root: plain Muon, Keller Jordan recipe (`shape_scaling`, LR 2e-2) | Muon (shape_scaling) | 2e-2 | 2.226 | 2.068 | [`03-muon-kj-lr2e-2.sbatch`](runs/03-muon-kj-lr2e-2.sbatch) | [f7uvsbai](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/f7uvsbai) | [`baseline-2026-05-08-a76e5bc`](https://github.com/ischlag/megatron-lm-research-baseline/tree/baseline-2026-05-08-a76e5bc) |
| 15 | normuon-lr2e-4 | normuon-lr3.6e-4 | LR 3.6e-4 -> 2e-4 | NorMuon | 2e-4 | 2.227 | 2.063 | [`02-normuon-lr2e-4.sbatch`](runs/02-normuon-lr2e-4.sbatch) | [heevf919](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/heevf919) | [`baseline-2026-05-08-a76e5bc`](https://github.com/ischlag/megatron-lm-research-baseline/tree/baseline-2026-05-08-a76e5bc) |
| 16 | normuon-fp8 | normuon-lr3.6e-4 | add `--fp8-format e4m3 --fp8-recipe blockwise` (DeepSeek-V3) | NorMuon (FP8) | 3.6e-4 | 2.229 | 2.065 | [`07-normuon-fp8.sbatch`](runs/07-normuon-fp8.sbatch) | [7j84uy3j](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/7j84uy3j) | [`598cbe616`](https://github.com/ischlag/megatron-lm-research-baseline/tree/598cbe616) |
| 17 | normuon-lr6e-4 | normuon-lr3.6e-4 | LR 3.6e-4 -> 6e-4 | NorMuon | 6e-4 | 2.244 | 2.081 | [`04-normuon-lr6e-4.sbatch`](runs/04-normuon-lr6e-4.sbatch) | [zu96uyts](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/zu96uyts) | [`baseline-2026-05-08-a76e5bc`](https://github.com/ischlag/megatron-lm-research-baseline/tree/baseline-2026-05-08-a76e5bc) |
| 18 | adamw-lr1e-3 |  | root: AdamW baseline (decoupled WD), LR 1e-3 | AdamW | 1e-3 | 2.316 | 2.154 | [`05-adamw-lr1e-3.sbatch`](runs/05-adamw-lr1e-3.sbatch) | [6qecfvwc](https://wandb.ai/ischlag/megatron-lm-research-baseline/runs/6qecfvwc) | [`baseline-2026-05-08-a76e5bc`](https://github.com/ischlag/megatron-lm-research-baseline/tree/baseline-2026-05-08-a76e5bc) |
...
- **`scion-qkn-moe-32e-tk3-sh1-lr3e-4`** (new leader): the dense Scion+QKN winner
  with the FFN replaced by the same fine-grained MoE as `aurora-qkn-moe`
  (32 routed experts top-3 + 1 shared, all width 640; iso-active ~355M, total
  ~1.73B). Optimizer is Scion (γ=3e-4) throughout. **MoE routing differs from
  the `aurora-qkn-moe` note below:** under `--moe-grouped-gemm` + TE the expert
  weights are stored as *per-expert 2-D* `nn.Parameter`s
  (`…experts.linear_fc1.weight{i}` / `linear_fc2.weight{i}`), **not** one stacked
  3-D `[E,m,n]` tensor. Scion's hidden-matrix rule is a *shape* predicate
  (`ndim==2`), so every per-expert matrix, the router `[E,H]`, and the shared
  expert all match Spectral@ρ50 and are **fully orthogonalized — none fall
  through to AdamW**. (Scion's `default_param_overrides` is empty, so a
  hypothetical stacked 3-D expert tensor would instead hard-fail at step 1 with
  `norm=None` — fail-loud, never a silent Adam misroute.) Same aux/z losses
  (1e-2 / 1e-3), grouped GEMM, alltoall dispatcher, EP=1 / DP=4, MBS 16→8 as the
  Aurora MoE. Beats the prior leader by −0.020 final / −0.021 min; MoE is the
  single biggest Scion-lineage jump (−0.089 final vs `scion-qkn`), matching the
  dense→MoE Aurora gain. Routing stays balanced (load-balancing ≈ 1.005).
- **`scion-qkn-lr3e-4`**: the dense Scion root + `--qk-layernorm` (per-head
  RMSNorm on Q, K). The new q/k norm gains are 1-D, so Scion routes them to
  BiasRMS@ρ50 (no special handling). QK-norm helps Scion at every γ (−0.022 to
  −0.036 final over the 2e-4/3e-4/4e-4 grid), the same direction as the
  `aurora → aurora-qkn` gain. Ties `aurora-qkn-xsa` on final loss (2.167) and
  edges it on min (2.005 < 2.009) with no attention change — plain Scion + QKN,
  no XSA, no MoE.
- **`scion-lr3e-4`** (root): Scion (Pethick et al., arXiv 2502.07529), a
  norm-constrained Frank-Wolfe / LMO optimizer. Per-layer norm oracles: Spectral
  (5-step quintic Newton-Schulz, hidden matrices, ρ=50), Sign (output head +
  token embedding, ρ=3000), BiasRMS (RMSNorm gains, ρ=50). Weight decay *is* the
  constraint: decoupled μ=1, pinned inside the optimizer and protected from the
  scheduler (the `--weight-decay 0.1` flag is ignored by Scion). matrix LR
  γ=3e-4 is the best of a 12-point sweep over [6e-5, 8e-4]; γ ≥ 1e-3 diverges
  because ρ=50 makes the literal Muon/Aurora LRs (1e-2, 2e-2) ~50× too
  aggressive — the FW constraint bounds operator norms but does not by itself
  stop loss divergence at large γ. At matched recipe, plain Scion already edges
  Aurora (2.196 vs 2.200) and beats NorMuon (2.224) / Muon (2.226) / AdamW
  (2.316). Steady throughput ~309 TFLOP/s/GPU (Newton-Schulz on small 2-D
  weights is ~free: ~3.5 ms / extra NS step).
